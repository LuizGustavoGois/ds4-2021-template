                                ...
                                <div
                                    ...
                                    <Card
                                        ...
                                        <CardActionArea>
                                            ...
                                            <CardContent
                                                className="project-card-title">
                                                {template.project.name.length >= 28 ? (

                                                    <Tooltip title={template.project.name}>
                                                        <Typography variant="h6" component="span">
                                                            {`${template.project.name.substring(0, 25)}...`}
                                                        </Typography>   
                                                    </Tooltip>
                                    ...
                                    <Avatar
                                        className="project-avatar"
                                        src={`../assets/avatar/${template.project.owner.avatar}`} 
                                        alt={template.project.owner.name}/>   
                                </div>
                            )
                        })}
                    </div>
